...
class ArrayTableViewController: UITableViewController {
    ...
    */
    ...
    override func override func viewDidLoad() {
        tableView(<#tableView: UITableView#>, cellForRowAtIndexPath: <#NSIndexPath#>)
    }
    let animalArray = [Animal(name: "Rover"), Animal(name: "Mittens"), Animal(name: "Ein"), Animal(name: "Sadie"), Dog(name: "Pup")]
